...
export const TAB_CONTAINER_SX: SxProps<Theme> = { padding: 2 };

/** Search bar wrapper. Flex row with gap, mb for sibling spacing. Wraps on narrow viewports. */
export const SEARCH_BAR_SX: SxProps<Theme> = {
  display: 'flex',
  alignItems: 'center',
  gap: 1,
  mb: 2,
...
export const ACCORDION_CONTROLS_SX: SxProps<Theme> = {
  display: 'flex',
  alignItems: 'center',
  gap: 1,
};
